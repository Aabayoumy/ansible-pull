...
if type -q exa
    ...
    alias ll="exa -lg --icons --color=always --group-directories-first --octal-permissions"
    alias la="ll -a"
end
...
if type -q eza
    ...
    alias ll="eza -lg --icons --color=always --group-directories-first --octal-permissions"
    alias la="ll -a"
end
